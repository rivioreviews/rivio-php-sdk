...
class Rivio {
    ...
    private function set_templates() {
        ...
        <script type="text/javascript">
            ...
            script.src = "https://embed.getrivio.com/init.min.js?api_key=<?php echo $this->api_key ?>";
        ...
        <div class="rivio-rating">
            ...
            <div class="rivio-rating-controls">
                <div class="rivio-rating-controls-stars rivio-embed-js-open">
                    {{header-rating-stars}}
                </div>
                <div class="rivio-rating-controls-title">
                    <a href="javascript:" class="rivio-embed-js-open">{{rate-title}}</a>
                </div>
            </div>
        </div>
        <?php
